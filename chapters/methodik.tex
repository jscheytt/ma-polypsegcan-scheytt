...
Selbst wenn das Netz qualitativ überzeugende Samples liefert, kann es passiert sein, dass die Wahrscheinlichkeitsverteilung, die der Generator gelernt hat, nur wenige Regionen oder sogar nur eine Region mit hoher Wahrscheinlichkeitsdichte abdeckt.
...
Die Ausgabe des Diskriminators sind die Aktivierungen seiner letzten Schicht, was einer 30$\times$30-Matrix entspricht, wobei jeder Bildpunkt dieser Matrix der Glaubwürdigkeit eines 70$\times$70-Ausschnittes des Bildes entspricht.
...
\begin{table}
	\centering
	\caption{Details zu den Datasets (SD und HD)}
	\label{tab:datasets}
