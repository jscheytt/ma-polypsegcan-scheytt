...
\begin{figure}
	...
	\begin{subfigure}{.19\textwidth}
		...
		\caption{Fake}
	\end{subfigure}
	\caption{Batch-Größe 3, Durchlauf B nach 6900 Schritten (ca. 78 Epochen): Datensatz mit Ausgabe}
...
\begin{figure}
	...
	\begin{subfigure}{.19\textwidth}
		...
		\caption{Fake}
	\end{subfigure}
	\caption{Batch-Größe 64, Durchlauf A am Ende des Trainings (600 Epochen): Datensatz mit Ausgabe}
