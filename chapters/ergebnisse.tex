...
\begin{table}
	...
	\begin{tabular}{rlll}
		...
		Scherung + Zoom & {\cellcolor[rgb]{0.859,0.894,0.584}}0,5557 & {\cellcolor[rgb]{0.965,0.925,0.604}}0,07206854 & {\cellcolor[rgb]{0.941,0.918,0.596}}0,04055263 \\ % TODO Ergebnisse shear+zoom eintragen
...
% TODO fig:lossbaselineAtoD alle 4
...
% TODO fig:ioutestfinal inkl. geom_smooth, erklären/interpretieren
