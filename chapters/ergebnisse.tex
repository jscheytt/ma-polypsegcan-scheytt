...
\begin{figure}
	\centering
	\includegraphics[width=.8\linewidth]{data/main_es}
...
% TODO Ergebnisse shear+zoom eintragen
...
\begin{table}
	...
	\caption[Mittlerer IoU der Augmentierungen auf den Validierungs- und Testdaten]{Mittlerer IoU der Augmentierungen auf den Validierungs- und Testdaten. Jede Zeile repräsentiert die Mittelung aller Modelle einer Augmentierung.}
	\begin{tabular}{rlll} 
		\toprule
		Augmentierung & IoU Val. & IoU Test & IoU Test (Standardabweichung) \\ 
		\midrule
...
\begin{losses}{baselinel1}
	\caption{Verläufe des CAN-Modells (dunkellila, dunkelblau, hellblau) und des rein L1-basierten Modells (türkis, hellgrün, gelb). Zwei Trainingsläufe des L1-Modells und einer des CAN-Modells wurden ungeplant frühzeitig bei Schritt 2000 beendet und konnten aus Zeitgründen nicht mehr vollständig wiederholt werden.}
