...
Als Interpolationsverfahren wurde die \emph{bikubische Interpolation} gewählt, weil sie unter allen Optionen die größte Region, nämlich eine 4$\times$4-Nachbarschaft um den zu interpolierenden Punkt, berücksichtigt.
