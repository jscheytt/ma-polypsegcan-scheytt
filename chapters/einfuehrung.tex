...
\begin{figure}
	...
	\begin{subfigure}{.45\textwidth}
		\centering
		\includegraphics[width=.9\linewidth]{polyp129}
		\caption{}
		\label{fig:polyp}
	\end{subfigure}
	\begin{subfigure}{.45\textwidth}
		\centering
		\includegraphics[width=.9\linewidth]{segm129}
		\caption{}
		\label{fig:segm}
	\end{subfigure}
...
Ein solcher Generator kann u.~a. für eine Bild-zu-Bild-Übersetzung genutzt werden wie bei \citeauthor{Isola.2017}~\cite{Isola.2017}; sie nennen ihren Ansatz \emph{\acrfullpl{can}}.
